...
if(length(I)==0)helpdlg('Image not uploaded. Please select the image');

else helpdlg('Image has been loaded successfully. Choose an algorithm and train the network  ',...
        'Load Image');
end
...
digitrecnn
      ...
      case 'Train using Bagged Decision Tree'
        train_dt
        helpdlg('Decision Trees has been trained. Click on "Recognise Digit" to process the image',...
        'Training Successfull');
    case 'Train using Ensemble Neural Network'
        train_ensemblenn
        helpdlg('Networks have been trained and ensembled. Click on "Recognise Digit" to process the image',...
        'Training Successfull');
  end
